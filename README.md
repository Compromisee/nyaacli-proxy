...
<p align="center"> <img src="https://img.shields.io/github/stars/yourusername/nyaacli-proxy?style=for-the-badge&color=yellow" alt="Stars"> <img src="https://img.shields.io/github/downloads/yourusername/nyaacli-proxy/total?style=for-the-badge&color=green" alt="Downloads"> <img src="https://img.shields.io/github/v/release/yourusername/nyaacli-proxy?style=for-the-badge&color=blue" alt="Release"> <img src="https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fgithub.com%2Fyourusername%2Fnyaacli-proxy&count_bg=%2379C83D&title_bg=%23555555&icon=github.svg&icon_color=%23E7E7E7&title=views&edge_flat=true" alt="Views"> <img src="https://img.shields.io/badge/dependencies-0-brightgreen?style=for-the-badge" alt="Dependencies"> <img src="https://img.shields.io/badge/node-%3E%3D16-green?style=for-the-badge&logo=nodedotjs" alt="Node"> </p><p align="center"> <strong>A local CORS proxy + GUI dashboard for <a href="https://nyaa.si">nyaa.si</a></strong> </p>
> A local CORS proxy + GUI dashboard for [nyaa.si](https://nyaa.si)
...
> **Leave this terminal open.** The proxy must keep running while you use the dashboard.
...
Type an anime name (e.g. `Frieren`, `Solo Leveling`, `One Piece`) and press **Enter** or click **Search**. Results come from the live nyaa.si RSS feed with real magnet links.
...
|---|---|
| **All / Trusted / No Remake / Batch** | Maps to nyaa's `f=` filter parameter. "Trusted" and "No Remake" trigger a new server request; "Batch" is filtered client-side. |
...
> Hover over any score badge in the table to see the full breakdown.
...
Then update the `PROXY` constant at the top of `dashboard.html`:
...
The sidebar dot turns red and search does nothing. Make sure:

1. You ran `node server.js` and it printed the startup banner.
2. You didn't close that terminal window.
3. Nothing else is using port 3030 — if so, try `PORT=3031 node server.js` and update `PROXY` in `dashboard.html`.
...
Port 3030 is already taken. Either:
...
Your OS doesn't have `magnet:` links associated with a torrent client. Fix:
